...
def get_classification_task(
    ...
    """Load a time series classification dataset from www.timeseriesclassification.com.
    ...
    train_dataset, train_target = load_classification(
        dataset_name, split="train", extract_path=data_dir
    )
    ...
    test_dataset, test_target = load_classification(
        dataset_name, split="test", extract_path=data_dir
    )
...
def get_mnist(
    ...
    full_train_dataset = torchvision.datasets.MNIST(
        data_dir, train=True, transform=torchvision.transforms.ToTensor(), download=True
    )
