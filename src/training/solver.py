"""A Solver class implementing training and inference logic for time series
...
class Solver:
    """Hidden states are computed via a single forward pass on the randomized ResRMN.
    Then, a simple linear readout (RidgeClassifier) is trained on the hidden states and
    used for inference.
